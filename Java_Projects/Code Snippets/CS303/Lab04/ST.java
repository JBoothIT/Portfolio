...
public class ST<Key extends Comparable<Integer>, Integer> implements Iterable<Integer> 
{
    private TreeMap<Key, Integer> st;
    ...
    {
        return (Iterator<Integer>) st.keySet().iterator();
    }
    ...
    {
        SortedMap<Key, Integer> tail = st.tailMap(k);
    ...
    public Key floor(Key k) 
    {
        ...
        SortedMap<Key, Integer> head = st.headMap(k);
